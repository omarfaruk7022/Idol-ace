...
const Footer = () => {
  return (
    <div>
      <footer aria-label="Site Footer" class="bg-white mt-28">
        <div class="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <div class="flex flex-col items-center gap-4 rounded-lg bg-accent p-6 shadow-lg sm:flex-row sm:justify-between">
            <strong class="text-xl text-white sm:text-xl">
              Make Your Next Career Move!
            </strong>

            <a
              class="inline-flex items-center rounded-full border border-white bg-white px-8 py-3 text-accent hover:bg-transparent hover:text-white focus:outline-none focus:ring active:bg-white/90"
              href="/"
            >
              ...
              <nav aria-label="Footer Services Nav" class="mt-8">
                <ul class="space-y-4 text-sm">
                  <li>
                    <a
                      class="text-gray-700 transition hover:text-gray-700/75"
                      href="https://www.smartfieldservice.com/"
                      target={"_blank"}
                    >
                      Web Development
                    </a>
          ...
          <div class="mt-16">
            <ul class="flex justify-center gap-6 sm:justify-end ">
              <li>
                <a
                  href="https://www.facebook.com/profile.php?id=100054207821240"
                  rel="noreferrer"
                  target="_blank"
                  class="text-accent transition hover:text-neutral"
                >
              ...
              <li>
                <a
                  href="https://twitter.com/IdolGroup3"
                  rel="noreferrer"
                  target="_blank"
                  class="text-accent transition hover:text-neutral"
                >
